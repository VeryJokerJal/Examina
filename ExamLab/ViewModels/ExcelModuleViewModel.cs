...
public class ExcelModuleViewModel : ModuleViewModelBase
{
    ...
    private static bool IsIndexParameter(string parameterName)
    {
        ...
        {
            "RowIndex", "RowNumber", "RowStart", "RowEnd",
            "ColumnIndex", "ColumnNumber", "ColumnStart", "ColumnEnd",
            "CellIndex", "CellNumber", "CellOrder",
            "SheetIndex", "SheetNumber", "SheetOrder",
            "RangeIndex", "RangeNumber", "RangeOrder",
