...
public class StudentExamDto
{
    ...
    /// 科目列表
    /// </summary>
    public ObservableCollection<StudentSubjectDto> Subjects { get; set; } = [];

    /// <summary>
    /// 模块列表
    /// </summary>
    public ObservableCollection<StudentModuleDto> Modules { get; set; } = [];
}
...
public class StudentSubjectDto
{
    ...
    /// 题目列表
    /// </summary>
    public ObservableCollection<StudentQuestionDto> Questions { get; set; } = [];
}
...
public class StudentQuestionDto
{
    ...
    /// 操作点列表
    /// </summary>
    public ObservableCollection<StudentOperationPointDto> OperationPoints { get; set; } = [];
}
...
public class StudentOperationPointDto
{
    ...
    /// 参数列表
    /// </summary>
    public ObservableCollection<StudentParameterDto> Parameters { get; set; } = [];
}
