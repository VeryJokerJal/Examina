...
public class StudentMockExamDto
{
    ...
    /// 题目列表
    /// </summary>
    public ObservableCollection<StudentMockExamQuestionDto> Questions { get; set; } = [];
}
...
public class StudentMockExamQuestionDto
{
    ...
    /// 操作点列表
    /// </summary>
    public ObservableCollection<StudentMockExamOperationPointDto> OperationPoints { get; set; } = [];
}
...
public class StudentMockExamOperationPointDto
{
    ...
    /// 参数列表
    /// </summary>
    public ObservableCollection<StudentMockExamParameterDto> Parameters { get; set; } = [];
}
...
public class CreateMockExamRequestDto
{
    ...
    /// 抽取规则列表
    /// </summary>
    public ObservableCollection<QuestionExtractionRuleDto> ExtractionRules { get; set; } = [];
}
