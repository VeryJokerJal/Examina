...
public class MockExamComprehensiveTrainingDto
{
    ...
    /// 科目列表
    /// </summary>
    public ObservableCollection<MockExamSubjectDto> Subjects { get; set; } = [];

    /// <summary>
    /// 模块列表
    /// </summary>
    public ObservableCollection<MockExamModuleDto> Modules { get; set; } = [];
    ...
    public ObservableCollection<MockExamQuestionDto>? Questions { get; set; }
}
...
public class MockExamQuestionDto
{
    ...
    /// 操作点列表
    /// </summary>
    public ObservableCollection<MockExamOperationPointDto> OperationPoints { get; set; } = [];
}
...
public class MockExamOperationPointDto
{
    ...
    /// 配置参数列表
    /// </summary>
    public ObservableCollection<MockExamParameterDto> Parameters { get; set; } = [];
}
