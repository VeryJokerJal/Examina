...
public class SchoolManagementApiController : ControllerBase
{
    private readonly IOrganizationService _organizationService;
    private readonly ILogger<SchoolManagementApiController> _logger;

    public SchoolManagementApiController(
        IOrganizationService organizationService,
        ILogger<SchoolManagementApiController> logger)
    {
