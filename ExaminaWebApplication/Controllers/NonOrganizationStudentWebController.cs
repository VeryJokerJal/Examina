...
public class NonOrganizationStudentWebController : Controller
{
    private readonly INonOrganizationStudentService _studentService;
    private readonly ILogger<NonOrganizationStudentWebController> _logger;

    public NonOrganizationStudentWebController(
        INonOrganizationStudentService studentService,
        ILogger<NonOrganizationStudentWebController> logger)
    {
