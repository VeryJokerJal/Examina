...
namespace ExaminaWebApplication.Migrations
{
    ...
    [Migration("20250808015835_AddWordOperationSystem")]
    partial class AddWordOperationSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.ExamExcelOperationParameter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ExamOperationPointId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ExamOperationPointId");

                    b.HasIndex("ParameterTemplateId");

                    b.ToTable("ExamExcelOperationParameters");
                });

            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.ExamExcelOperationPoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ExamExcelOperationPoints");
                });
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.ExamSubjectOperationPoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OperationSubjectType")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1);
                    ...
                    b.HasIndex("OperationSubjectType");

                    b.HasIndex("SortOrder");

                    b.ToTable("ExamSubjectOperationPoints");
                });

            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.SimplifiedQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("OperationConfig")
                        .IsRequired()
                        .HasColumnType("json");
                    ...
                    b.ToTable("SimplifiedQuestions");
                });

            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.WindowsQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WindowsQuestions");
                });

            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.WindowsQuestionOperationPoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WindowsQuestionOperationPoints");
                });

            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.WordQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.WordQuestionOperationPoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("WordQuestionOperationPoints");
                });
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Practice.PracticeQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Practice.SpecializedPractice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SpecializedPractices");
                });
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.ExamExcelOperationParameter", b =>
                {
                    ...
                    b.HasOne("ExaminaWebApplication.Models.Exam.ExamExcelOperationPoint", "ExamOperationPoint")
                        .WithMany("Parameters")
                        .HasForeignKey("ExamOperationPointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ExaminaWebApplication.Models.Excel.ExcelOperationParameterTemplate", "ParameterTemplate")
                        .WithMany()
                        .HasForeignKey("ParameterTemplateId");

                    b.Navigation("EnumType");

                    b.Navigation("ExamOperationPoint");
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.ExamExcelOperationPoint", b =>
                {
                    b.HasOne("ExaminaWebApplication.Models.Exam.Exam", "Exam")
                        .WithMany("ExcelOperationPoints")
                        .HasForeignKey("ExamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ExaminaWebApplication.Models.Excel.ExcelOperationTemplate", "Template")
                        .WithMany()
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.SimplifiedQuestion", b =>
                {
                    b.HasOne("ExaminaWebApplication.Models.Exam.ExamSubject", "Subject")
                        .WithMany()
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.WindowsQuestionOperationPoint", b =>
                {
                    b.HasOne("ExaminaWebApplication.Models.Exam.WindowsQuestion", "Question")
                        .WithMany("OperationPoints")
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.WordQuestionOperationPoint", b =>
                {
                    b.HasOne("ExaminaWebApplication.Models.Exam.WordQuestion", "Question")
                        .WithMany("OperationPoints")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Practice.PracticeQuestion", b =>
                {
                    b.HasOne("ExaminaWebApplication.Models.Practice.SpecializedPractice", "Practice")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Exam.Exam", b =>
                {
                    b.Navigation("ExcelOperationPoints");
