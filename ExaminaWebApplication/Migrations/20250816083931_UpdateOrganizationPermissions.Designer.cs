...
namespace ExaminaWebApplication.Migrations
{
    ...
    [Migration("20250816083931_UpdateOrganizationPermissions")]
    partial class UpdateOrganizationPermissions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Organization.InvitationCode", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Code = "INST001",
                            CreatedAt = new DateTime(2024, 8, 1, 0, 0, 0, 0, DateTimeKind.Utc),
                            ExpiresAt = new DateTime(2024, 8, 31, 0, 0, 0, 0, DateTimeKind.Utc),
                            IsActive = true,
                            MaxUsage = 100,
                            OrganizationId = 2,
                            UsageCount = 0
            ...
            modelBuilder.Entity("ExaminaWebApplication.Models.Organization.StudentOrganization", b =>
                {
                    ...
                    b.HasIndex("StudentId", "OrganizationId")
                        .IsUnique();
