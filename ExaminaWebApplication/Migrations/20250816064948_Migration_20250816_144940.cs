...
{
    /// <inheritdoc />
    public partial class Migration_20250816_144940 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AllowMultipleDevices", "CreatedAt", "Email", "IsActive", "LastLoginAt", "MaxDeviceCount", "PasswordHash", "PhoneNumber", "RealName", "Role", "StudentId", "UpdatedAt", "Username", "WeChatOpenId" },
                values: new object[] { 1, true, new DateTime(2024, 8, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@examina.com", true, null, 5, "$2a$11$8K1p/a0dL2LkqvQOuiOX2uy7YIr1w1yuBVMxVVehboYg7iYfZb4W2", "13800138000", "系统管理员", 3, "ADMIN001", null, "admin", null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "IsActive", "IsFirstLogin", "LastLoginAt", "MaxDeviceCount", "PasswordHash", "PhoneNumber", "RealName", "Role", "StudentId", "UpdatedAt", "Username", "WeChatOpenId" },
                values: new object[] { 2, new DateTime(2024, 8, 1, 0, 0, 0, 0, DateTimeKind.Utc), "student001@examina.com", true, true, null, 1, "$2a$11$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi", "13800138001", "张三", 1, "2024001", null, "student001", null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AllowMultipleDevices", "CreatedAt", "Email", "IsActive", "LastLoginAt", "MaxDeviceCount", "PasswordHash", "PhoneNumber", "RealName", "Role", "StudentId", "UpdatedAt", "Username", "WeChatOpenId" },
                values: new object[] { 3, true, new DateTime(2024, 8, 1, 0, 0, 0, 0, DateTimeKind.Utc), "teacher001@examina.com", true, null, 3, "$2a$11$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi", "13800138002", "李老师", 2, "TEACHER001", null, "teacher001", null });
