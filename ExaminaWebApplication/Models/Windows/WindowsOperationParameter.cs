...
/// <summary>
/// Windows操作参数配置表 - 存储每个操作点的可配置参数
/// </summary>
public class WindowsOperationParameter
{
    /// <summary>
    /// 主键ID
    /// </summary>
    ...
    /// </summary>
    [Required]
    public WindowsParameterDataType DataType { get; set; }
    ...
    /// </summary>
    [JsonIgnore]
    public virtual WindowsEnumType? EnumType { get; set; }
}

/// <summary>
/// Windows参数数据类型枚举
/// </summary>
public enum WindowsParameterDataType
{
    /// <summary>
    /// 字符串类型
    /// </summary>
